<?php
    ...
    /**
     * Checks that a property is protected.
     * @package Wingman\Helix\Terms
     * @author Angel Politis <info@angelpolitis.com>
     * @since 1.0
     */
    class PropertyIsProtectedTerm extends PropertyContractTerm {
        /**
         * Evaluates whether a property is protected on the given object or class.
         * @param object|string $objOrClass The object or class name to check.
         * @return bool Whether the property is protected.
         */
        ...
        /**
         * Gets the error message for when a property is not protected.
         * @return string The error message.
         */
        public function getErrorMessage () : string {
            return "Property '{$this->property->getName()}' is not protected.";
        }
    }
?>